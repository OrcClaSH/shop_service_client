      ...
      <div className="cart">
        <div className="cart__top">
          ...
          <div className="cart__clear">
            ...
            {/* TODO check visible button */}
            <button onClick={handleClearItems} type="button">
              Очистить корзину
            </button>
          </div>
        </div>
        <div className="content__items">
          {!!items.length &&
            items.map((item) => <ProductCart {...item} key={item.idProduct} />)}
        </div>
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span>
              {' '}
              Всего: <b>{sumProducts(items)} шт.</b> / разновидностей:{' '}
              <b>{items.length}</b>
            </span>
            <span />
            <span>

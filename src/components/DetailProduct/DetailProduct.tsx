...
const DetailProduct: React.FC = () => {
    ...
    const productDescription = product?.full_data
        ? product.full_data.split(';')
        : []
                    ...
                    <div className={st['product-block']}>
                        ...
                        <div className={st['product-block__description-wrapper']}>
                            ...
                            <div className={st['product-block__about']}>
                                {productDescription.map(about => <p className={st['product-block__about-text']} key={about}>{about}</p>)}
                            </div>
